...
public class OpenRo {
	...
	private String vin;
	private Long openRoVehicleIdFk;
...
//	private Timestamp updatedOn;
	...
	/**
	 * @return the openRoVehicleIdFk
	 */
	public Long getOpenRoVehicleIdFk() {
		return openRoVehicleIdFk;
	}

	/**
	 * @param openRoVehicleIdFk the openRoVehicleIdFk to set
	 */
	public void setOpenRoVehicleIdFk(Long openRoVehicleIdFk) {
		this.openRoVehicleIdFk = openRoVehicleIdFk;
	}
